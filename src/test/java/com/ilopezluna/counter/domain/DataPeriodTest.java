...
public class DataPeriodTest {
    ...
    public void testGetFrom() throws Exception {
        DataPeriod dataPeriod = new DataPeriod(DEFAULT_FROM, DEFAULT_TO);
    ...
    public void testHit() throws Exception {
        DataPeriod base = new DataPeriod(DEFAULT_FROM, DEFAULT_TO);
        DataPeriod against = new DataPeriod(DEFAULT_FROM, DEFAULT_TO);
